...
public class Menu {
    ...
    public void run() {
                ...
                while (true) {
                    ...
                    switch (choice) {
                        case 1: // Klar
                            ...
                            break;
                        case 2:
                            // Fixa med id + funkar inte
                          ClothingItemService.updateClothingItem(currentUser.getAccess_token(), 1,1);
                            break;
                        case 3:
                            // Fixa med id
                            ClothingItemService.deleteClothingItem(currentUser.getAccess_token(), 2);
                            break;
                        case 4:
                            // Fixa med id
                            ClothingItemService.getClothingItemById(currentUser.getAccess_token(), 1);
                            break;
                            case 5:
                            ClothingItemService.getAllClothingItems(currentUser.getAccess_token());
                                break;
                            case 6:
        ...
        private static void printAdminMenu() {
            ...
            System.out.println("4. Show Products with ID");
