...
public class Menu {
    ...
    public void run() {
                ...
                while (true) {
                    ...
                    switch (choice) {
                        ...
                        case 3:
                            // Fixa med id
                            FruitItemServices.getAllFruitsItems(currentUser.getAccess_token());
                            FruitItemServices.deleteFruitItem(currentUser.getAccess_token());
                            break;
                            case 4:
                                FruitItemServices.getAllFruitsItems(currentUser.getAccess_token());
                                break;
                ...
                while (true) {
                    ...
                    switch (choice) {
                        ...
                        case 2:
                            ...
                            FruitItemServices.getAllFruitsItems(currentUser.getAccess_token());
                            CartService.addToCart(currentUser.getAccess_token());
                            break;
                        case 3:

                            CartService.removeCartItemById(currentUser.getAccess_token());
                            break;
                        case 4:
        ...
        private static void printAdminMenu() {
            ...
            System.out.println("4. Show all fruits");
